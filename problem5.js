...
const result = onlyYearsOlder(inventory);

function onlyYearsOlder(cars) {
  let arrYearsOlder = [],
    indexOlder = 0;

  for (i = 0; i < cars.length; i++) {
    if (cars[i].car_year < 2000) {
      arrYearsOlder[indexOlder] = cars[i].car_year;
      indexOlder++;
    }
  }
  console.log(arrYearsOlder);
  console.log(arrYearsOlder.length);
  return arrYearsOlder;
}
